...
$tshirt = [
    'id' => $tshirt_id,
    'name' => 'Stronger Than You Think - Neon Boxing Motivation Tee',
    'price' => '16',
    'description' => 'Unleash your inner champion with the "Stronger Than You Think" T-shirt. Featuring a striking neon graphic of contrasting boxing gloves, fists, and arrows, this design is a bold statement of resilience. The text proclaims "YOU ARE STRONGER THAN YOU THINK" and "KEEP GOING," while reminding wearers that "EVERYONE FACES CHALLENGES. YOUR EFFORT IS TRULY MATTERS." Perfect for gym wear, training, or as a daily dose of motivation. Est. 2005.',
    
    // 🟢 FIX: Changed outer quotes to single quotes to simplify internal double quotes.
    // Also completed the description/alt_text which was truncated.
    'alt_text' => 'Black T-shirt with white and neon graphic. Text: "YOU ARE STRONGER THAN YOU THINK" "EST. 2005" "KEEP GOING" "EVERYONE FACES CHALLENGES. YOUR EFFORT IS TRULY MATTERS." Graphic features a red neon boxing glove and a blue neon boxing glove crossed, surrounded by neon arrows.',
    
    'buy_link' => 'https://www.teepublic.com/t-shirt/83242098-youre-stronger-than-you-think', // Dummy buy link
];

// 🔴 CRITICAL REMINDER: The relative paths below will likely break unless you replace them
// with full URLs or correct relative paths to your public images.
$DUMMY_IMAGE_LINKS = [
    // === PASTE YOUR ACTUAL IMAGE LINKS HERE ===
    'admin/image_uploads/tshirts_6-T_1.png', // <-- Replace this with your first link
    'admin/image_uploads/tshirts_6-T_2.png', // <-- Replace this with your second link
    'admin/image_uploads/tshirts_6-T_3.png', // <-- Replace this with your third link
    'admin/image_uploads/tshirts_6-T_4.png'  // <-- Replace this with your fourth link
    // ===================================
];

...
$tshirt = [
    'id' => $tshirt_id,
    'name' => 'The Engine of Worlds(Abstract Machine Flow) T-Shirt',
    'price' => '16',
    'description' => 'A stunning and intricate geometric design that blends steampunk, cybernetic, and Art Deco influences. This highly detailed print features interlocking shapes, gears, and mechanical elements rendered in a sophisticated palette of muted blue, bronze/copper, and off-white tones. The overall composition suggests a complex, central machine or a digital blueprint, perfect for lovers of abstract art, sci-fi, industrial design, and unique statement apparel.',
    'alt_text' => "Abstract mechanical geometric illustration in blue, bronze, and cream colors. Intricate, complex, symmetrical design resembling a futuristic machine or digital motherboard. Keywords: Steampunk art, abstract geometric, mechanical design, cyberpunk, intrica",
    'buy_link' => 'https://www.teepublic.com/t-shirt/83068012-the-engine-of-worlds-abstract-machine-flow', // Dummy buy link
...
$DUMMY_IMAGE_LINKS = [
    ...
    'admin/image_uploads/tshirts_3-T_1.jpeg', // <-- Replace this with your first link
    'admin/image_uploads/tshirts_3-T_2.png', // <-- Replace this with your second link
    'admin/image_uploads/tshirts_3-T_3.png', // <-- Replace this with your third link
    'admin/image_uploads/tshirts_3-T_4.png'  // <-- Replace this with your fourth link
    // ===================================
];

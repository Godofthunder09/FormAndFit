...
// Fetch all ACCESSORIES from database. Alias 'alt_text' as 'alt' to match HTML usage.
$query = "SELECT id, name, price, image_url_1, alt_text AS alt FROM accessories ORDER BY name ASC";
...
<head>
    ...
    <title>FormAndFit - Accessories Collection</title>
...
<body class="bg-gray-50">
    ...
    <nav class="bg-white shadow-sm sticky top-0 z-50">
                    ...
                    <div class="hidden sm:ml-6 sm:flex sm:space-x-8">
                        ...
                        <div class="dropdown relative">
                            ...
                            <div class="dropdown-menu absolute hidden bg-white shadow-lg rounded-md mt-1 py-1 w-48 z-20">
                                ...
                                <a href="accessories.php" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 font-semibold text-red-600">Accessories</a>
                            </div>
                        </div>
        ...
        <div id="mobile-menu" class="mobile-menu fixed inset-y-0 right-0 w-64 bg-white shadow-lg transform translate-x-full hidden">
            ...
            <div class="px-4 pt-2 pb-3 space-y-1">
                ...
                <a href="accessories.php" class="block px-3 py-2 rounded-md text-base font-medium text-red-600 hover:text-gray-900 hover:bg-gray-50">Accessories</a>
    ...
    <div class="relative bg-gray-900 overflow-hidden" id="hero-section">
                    ...
                    <div class="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                        <div class="sm:text-center lg:text-left">
                            <h1 class="text-4xl tracking-tight font-extrabold text-white sm:text-5xl md:text-6xl">
                                ...
                                <span class="block text-red-400">Workout Accessories</span>
                            </h1>
                            <p class="mt-3 text-base text-gray-300 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                                Find all the essential gear to enhance your performance and style, from bags to bottles.
                            </p>
                            <div class="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                                <div class="rounded-md shadow">
                                    <a href="#accessories-collection" class="w-full flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium rounded-md text-white bg-red-600 hover:bg-red-700 md:py-4 md:text-lg md:px-10">
        ...
        <div class="lg:absolute lg:inset-y-0 lg:right-0 lg:w-1/2">
            <img class="h-56 w-full object-cover sm:h-72 md:h-96 lg:w-full lg:h-full relative z-10" src="/formandfit/Data/aa.png" alt="A collection of gym accessories like a water bottle and bag.">
        </div>
    </div>

    <div class="bg-white" id="accessories-collection">
        <div class="max-w-7xl mx-auto py-12 px-4 sm:py-16 sm:px-6 lg:px-8">
            <h2 class="text-3xl font-extrabold text-gray-900 text-center">Accessories Collection</h2>
            <p class="mt-4 max-w-2xl text-xl text-gray-500 mx-auto text-center">
                The tools you need for a complete workout experience.
            </p>
            <div class="mt-8 grid grid-cols-2 gap-y-10 gap-x-6 sm:grid-cols-2 lg:grid-cols-4 xl:gap-x-8">
                <?php foreach ($accessories as $accessory): ?>
                    <div class="group relative product-card bg-white rounded-lg shadow-md hover:shadow-lg transition duration-300">
                        <div class="w-full min-h-80 bg-gray-200 aspect-w-1 aspect-h-1 rounded-t-lg overflow-hidden lg:h-80 lg:aspect-none">
                            <img src="admin/<?php echo htmlspecialchars($accessory['image_url_1']); ?>" 
                                alt="<?php echo htmlspecialchars($accessory['alt']); ?>" 
                                class="w-full h-full object-center object-cover group-hover:opacity-75">
                        </div>
                        <div class="p-4">
                            <h3 class="text-sm text-gray-700">
                                <a href="accessories_details.php?id=<?php echo htmlspecialchars($accessory['id']); ?>">
                                    <span aria-hidden="true" class="absolute inset-0"></span>
                                    <?php echo htmlspecialchars($accessory['name']); ?>
                                </a>
                            </h3>
                            <p class="mt-1 text-lg font-medium text-gray-900">$<?php echo number_format($accessory['price'], 2); ?></p>
                ...
                <?php if (empty($accessories)): ?>
                    <div class="col-span-full text-center py-10">
                        <p class="text-xl text-gray-600">No accessories found in the collection.</p>
                        <p class="text-gray-500">Please check the database connection and the 'accessories' table.</p>
                    </div>
                <?php endif; ?>
            </div>
        </div>
    ...
    <script>
        // All modal and wishlist logic removed.

        // Mobile menu toggle
        document.getElementById('mobile-menu-button').addEventListener('click', function() {
            const menu = document.getElementById('mobile-menu');
            menu.classList.remove('hidden');
            // Use requestAnimationFrame for smoother transition initiation
        ...
        document.getElementById('close-menu').addEventListener('click', function() {
            ...
            // Re-hide the menu after the transition completes
